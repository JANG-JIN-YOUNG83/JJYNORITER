...
void CExcelWrapClass::AddImageFileDatas(long nRow, LPCTSTR szCellName, LPCTSTR szImageFileName_Dark,
    LPCTSTR szImageFileName_Bright, LPCTSTR szImageFileName_Bin, vector<CString> vecResultData, CString strDefectResult,
    IPVM::Rect ROIrt, IPVM::Rect DefectROIrt, LPCTSTR szImageOriginPath)
{
    Step_Reset(DIR_ALL);
   // m_pSheet->setCol(GetPositionX(), GetPositionX(), 50);
   // m_pSheet->setRow(GetPositionY(), 50);
    ...
    else
    {
        ...
        SaveJPGImage_Dark(szImageFileName_Dark, 63, 140, ROIrt, FALSE);
        SaveJPGImage_Bin(szImageFileName_Bin, 63, 140, ROIrt, FALSE);
        SaveJPGImage_DefectROI(szImageOriginPath, 63, 140, ROIrt, DefectROIrt);
    }
    for (long n = nNumber; n < vecResultData.size(); n++)
    {
        //Next_X();
...
void CExcelWrapClass::AddImageFileData(long nRow, LPCTSTR szCellName, LPCTSTR szImageFileName_Dark, LPCTSTR szImageFileName_Bright, vector<CString> vecResultData, vector<long> vecResultValue)
 {
	...
	//formatColor->setBorderBottom(BORDERSTYLE_THIN);
	formatColor->setFillPattern(FILLPATTERN_SOLID);
	//formatColor->setPatternForegroundColor(COLOR_LIGHTGREEN);
 ...
 //   m_pSheet->setCol(TOTALIMAGE, TOTALIMAGE, 20);
	...
	//for(long i=0 ; i < (long)vecResultValue.size();i++)
	//{
	//	// 이진호 변경 코드 20161217 ( Result 갯수를 출력해준다. )

	//	m_pSheet->writeNum(GetPositionY(), GetPositionX(), vecResultValue[i],format1);

	//	//if(vecResultValue[i] > PASS)//색상 봐꿔서.. 다시 저장.
	//	{
	//		//Format* totalFormat = m_pBook->addFormat();
	//		//totalFormat->setAlignH(ALIGNH_CENTER);
	//		//totalFormat->setBorderTop(BORDERSTYLE_THIN);
	//		//totalFormat->setBorderLeft(BORDERSTYLE_THIN);
	//		//totalFormat->setBorderRight(BORDERSTYLE_THIN);
	//		//totalFormat->setBorderBottom(BORDERSTYLE_THIN);
	//		//totalFormat->setAlignV(ALIGNV_CENTER);
	//		//totalFormat->setFillPattern(FILLPATTERN_SOLID);
	//		//totalFormat->setPatternForegroundColor(COLOR_ROSE);
	//		//
	//		//m_pSheet->writeNum(GetPositionY(), GetPositionX(),vecResultValue[i],totalFormat);
	//	}
	//	Next_X();
	//}
	//Next_Y();
}
//void CExcelWrapClass::AddRejectData(long nRow, LPCTSTR szImageFileName, LPCTSTR szInspName, SBlob sBlob, CString strCriteriaName, vector<CString> vecInspInfo)
//{
//	Format* format1 = m_pBook->addFormat();
//	format1->setBorderTop(BORDERSTYLE_THIN);
//	format1->setBorderLeft(BORDERSTYLE_THIN);
//	format1->setBorderRight(BORDERSTYLE_THIN);
//	format1->setBorderBottom(BORDERSTYLE_THIN);
//	format1->setAlignV(ALIGNV_BOTTOM);
//	format1->setWrap();
//
//	CString  strBlobInfo=_T("");
//	CString strData = _T("");
//	SaveJPGImage(szImageFileName,140,140,TRUE);
//	Next_Y(nRow);
//	//strBlobInfo.Format(_T("_A_Contrast : %.3f, K_Contrast : %.3f, Length : %.3fm, Width: %.3fm, Area: %.3fm, Deviation: %.3f, Thickness: %.3f, Locus: %.3f, E_Energy: %.3f"),
//	//	sBlob.fAverageContrast, sBlob.fKeyContrast, sBlob.fLength, sBlob.fWidth, sBlob.fArea, sBlob.fDeviation, sBlob.fThickness, sBlob.fLocus, sBlob.fEdgeEnergy);
//	CString strInspItem;
//	
//	for (long nSettingValue = 0; nSettingValue < vecInspInfo.size(); nSettingValue++)
//	{
//		strInspItem.Format(_T("%s"), vecInspInfo[nSettingValue]);
//	
//		if (strCriteriaName.Find(_T("_Criteria")) >= 0)
//		{
//			if (-1 != sBlob.fArea)
//			{
//				strBlobInfo.Format(_T("fArea[%f],"), sBlob.fArea);
//			}
//		}
//
//		if (strCriteriaName.Find(_T("_BlobCriteria")) >= 0)
//		{
//			if (strInspItem.Find(_T("Area")) >= 0)
//			{
//				if (-1 != sBlob.fArea)
//				{
//					strBlobInfo.Format(_T("fArea[%f]\r\n"), sBlob.fArea);
//					strData += strBlobInfo;
//				}
//			}
//			
//			if (strInspItem.Find(_T("SizeX")) >= 0)
//			{
//				if (-1 != sBlob.fSizeX)
//				{
//					strBlobInfo.Format(_T("fSizeX[%f]\r\n"), sBlob.fSizeX);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("SizeY")) >= 0)
//			{
//				if (-1 != sBlob.fSizeY)
//				{
//					strBlobInfo.Format(_T("fSizeY[%f]\r\n"), sBlob.fSizeY);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("SizeXYMean")) >= 0)
//			{
//				if (-1 != sBlob.fSizeXYMean)
//				{
//					strBlobInfo.Format(_T("fSizeXYMean[%f]\r\n"), sBlob.fSizeXYMean);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("Width")) >= 0)
//			{
//				if (-1 != sBlob.fWidth)
//				{
//					strBlobInfo.Format(_T("fWidth[%f]\r\n"), sBlob.fWidth);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("Length")) >= 0)
//			{
//				if (-1 != sBlob.fLength)
//				{
//					strBlobInfo.Format(_T("fLength [%f]\r\n"), sBlob.fLength);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("WidthLengthMean")) >= 0)
//			{
//				if (-1 != sBlob.fWidthLengthMean)
//				{
//					strBlobInfo.Format(_T("fWidthLengthMean[%f]\r\n"), sBlob.fWidthLengthMean);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("AspectRatio")) >= 0)
//			{
//				if (-1 != sBlob.fAspectRatio)
//				{
//					strBlobInfo.Format(_T("fAspectRatio[%f]\r\n"), sBlob.fAspectRatio);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("AreaRatio")) >= 0)
//			{
//				if (-1 != sBlob.fAreaRatio)
//				{
//					strBlobInfo.Format(_T("fAreaRatio[%f]\r\n"), sBlob.fAreaRatio);
//					strData += strBlobInfo;
//				}
//			}
//			
//			if (strInspItem.Find(_T("LocalWidth")) >= 0)
//			{
//				if (-1 != sBlob.fLocalWidth)
//				{
//					strBlobInfo.Format(_T("fLocalWidth[%f]\r\n"), sBlob.fLocalWidth);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("ThinnessRatio")) >= 0)
//			{
//				if (-1 != sBlob.fThinnessRatio)
//				{
//					strBlobInfo.Format(_T("fThinnessRatio[%f]\r\n"), sBlob.fThinnessRatio);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("KeyContrast")) >= 0)
//			{
//				if (-1 != sBlob.fKeyContrast)
//				{
//					strBlobInfo.Format(_T("fKeyContrast[%f]\r\n"), sBlob.fKeyContrast);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("AverageContrast")) >= 0)
//			{
//				if (-1 != sBlob.fAverageContrast)
//				{
//					strBlobInfo.Format(_T("fAverageContrast[%f]\r\n"), sBlob.fAverageContrast);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("Deviation")) >= 0)
//			{
//				if (-1 != sBlob.fDeviation)
//				{
//					strBlobInfo.Format(_T("fDeviation[%f]\r\n"), sBlob.fDeviation);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("EdgeEnergy")) >= 0)
//			{
//				if (-1 != sBlob.fEdgeEnergy)
//				{
//					strBlobInfo.Format(_T("fEdgeEnergy[%f]\r\n"), sBlob.fEdgeEnergy);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("SearchRange")) >= 0)
//			{
//				if (-1 != sBlob.fBlobSearchRange)
//				{
//					strBlobInfo.Format(_T("fBlobSearchRange[%f]\r\n"), sBlob.fBlobSearchRange);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("InnerRangeNumber")) >= 0)
//			{
//				if (-1 != sBlob.nBlobInnerRangeNumber)
//				{
//					strBlobInfo.Format(_T("nBlobInnerRangeNumber[%f]\r\n"), sBlob.nBlobInnerRangeNumber);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("DeviationPos")) >= 0)
//			{
//				if (-1 != sBlob.fDeviationPos)
//				{
//					strBlobInfo.Format(_T("fDeviationPos[%f]\r\n"), sBlob.fDeviationPos);
//					strData += strBlobInfo;
//				}
//			}
//
//			if (strInspItem.Find(_T("Diameter")) >= 0)
//			{
//				if (-1 != sBlob.fDiameter)
//				{
//					strBlobInfo.Format(_T("fDiameter[%f]\r\n"), sBlob.fDiameter);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("Depth")) >= 0)
//			{
//				if (-1 != sBlob.fDepth)
//				{
//					strBlobInfo.Format(_T("fDepth[%f]\r\n"), sBlob.fDepth);
//					strData += strBlobInfo;
//				}
//			}
//			if (strInspItem.Find(_T("IFCount")) >= 0)
//			{
//				if (-1 != sBlob.nBlobIFCount)
//				{
//					strBlobInfo.Format(_T("nBlobIFCount[%f]\r\n"), sBlob.nBlobIFCount);
//					strData += strBlobInfo;
//				}
//			}
//		}
...
//	m_pSheet->writeStr(GetPositionY(), GetPositionX(), strData, format1); //파일 경로 Display
//}
...
void CExcelWrapClass::AddPicture(LPCTSTR szImageFileName, long nImageWidth, long nImageHeight, long nCol)
{
	Format* format1 = m_pBook->addFormat();
	format1->setBorderTop(BORDERSTYLE_THIN);
	format1->setBorderLeft(BORDERSTYLE_THIN);
...
IPVM::Image_8u_C1& CExcelWrapClass::SaveJPGImage_DefectROI(
    LPCTSTR szImageFileName, long nImageWidth, long nImageHeight, IPVM::Rect ROIrt, IPVM::Rect ROIDefectrt)
{
    IPVM::Image_8u_C1 TempJpgImg_R(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    IPVM::Image_8u_C1 TempJpgImg_G(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    IPVM::Image_8u_C1 TempJpgImg_B(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    IPVM::Image_8u_C3 CombineImg;
    CombineImg.Create(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    //memcpy(TempJpgImg.GetMem2D(), m_imgDst.GetMem2D(), (m_imgDst.GetSizeX() * m_imgDst.GetSizeY()));
    TempJpgImg_R.Create(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    IPVM::ImageProcessing::Copy(m_imgSrc, IPVM::Rect(m_imgSrc), TempJpgImg_R);
    TempJpgImg_G.Create(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    IPVM::ImageProcessing::Copy(m_imgSrc, IPVM::Rect(m_imgSrc), TempJpgImg_G);
    TempJpgImg_B.Create(m_imgSrc.GetSizeX(), m_imgSrc.GetSizeY());
    IPVM::ImageProcessing::Copy(m_imgSrc, IPVM::Rect(m_imgSrc), TempJpgImg_B);

    IPVM::ImageProcessing::CombineRGB(TempJpgImg_R, TempJpgImg_G, TempJpgImg_B, IPVM::Rect(m_imgSrc), CombineImg);
    IPVM::Rect rt;
    IPVM::Point_8u_C3 val2;
    val2.m_x = 0;
    val2.m_y = 0;
    val2.m_z = 255;
    IPVM::Image_8u_C3 CombineImg_Linear(m_imgSrc.GetSizeX() / 32, m_imgSrc.GetSizeY() / 32);
   // IPVM::ImageProcessing::Resize_Linear(CombineImg, CombineImg_Linear);
    ...
    if (rt.m_left < 0)
        rt.m_left = 0;
    if (rt.m_right > m_imgSrc.GetSizeX()-1)
        rt.m_right = m_imgSrc.GetSizeX()-1;
    if (rt.m_top < 0)
        rt.m_top = 0;
    if (rt.m_bottom > m_imgSrc.GetSizeY())
        rt.m_bottom = m_imgSrc.GetSizeY()-1;
    ...
    AddPicture_Origin(_T("D:\\CombineImg_Linear.jpg"), rttc.Width() * 3, rttc.Height(), 4);

    return m_imgSrc; //실제로는 ::GetProcBuffer(nThread, 0) 주소
}

void CExcelWrapClass::AddPicture_Origin( LPCTSTR szImageFileName, long nImageWidth, long nImageHeight, long nCol)
{
    Format* format1 = m_pBook->addFormat();
    format1->setBorderTop(BORDERSTYLE_THIN);
    format1->setBorderLeft(BORDERSTYLE_THIN);
    ...
    {
        m_pSheet->setPicture2(GetPositionY(), GetPositionX() + nCol, nImageID, 190, 60); // 요놈이 메인 이미지
    }
