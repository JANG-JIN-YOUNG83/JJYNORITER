...
public:
    ...
    void AddImageFileDatas(long nRow, LPCTSTR szCellName, LPCTSTR szImageFileName_Dark, LPCTSTR szImageFileName_Bright,
        LPCTSTR szImageFileName_Bin, vector<CString> vecResultData, CString strDefectResult, IPVM::Rect ROIrt,
        IPVM::Rect DefectROIrt, LPCTSTR szImageOriginPath = _T(""));
    void AddImageFileDatas(long nRow, LPCTSTR szCellName, LPCTSTR szImageFileName_Dark, LPCTSTR szImageFileName_Bright,
        LPCTSTR szImageFileName_Bin, vector<CString> vecResultData, CString strDefectResult, IPVM::Rect ROIrt);
	...
	void AddPicture(LPCTSTR szImageFileName, long nImageWidth, long nImageHeight, long nCol = 0);
    void AddPicture_Origin(LPCTSTR szImageFileName, long nImageWidth, long nImageHeight, long nCol = 0);
