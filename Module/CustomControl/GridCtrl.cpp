...
#include "MemDC.h"
#include "GridCtrl.h"
//#include "..\dPI_MsgDialog\SimpleMessage.h"
...
//        SimpleMessage(_T("OLE initialization failed. Make sure that the OLE libraries are the correct version"));
    ...
    m_bHScrollClicked = FALSE; //20231101 [jjh]
...
void CGridCtrl::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	::SendMessage(pParentWnd->GetSafeHwnd(),WM_KEYDOWN,nChar,nRepCnt);
    ...
    case SB_THUMBTRACK:
        {
            ...
            SetHScrollClicked(TRUE); //2023.10.31 Feeder Scroll Focus //20231101 [jjh]
        }
        break;
...
void CGridCtrl::OnSelecting(const CCellID& currentCell)
{
    ...
    case MOUSE_SELECT_CELLS:
        ...
        SetHScrollClicked(FALSE); //2023.10.31 Feeder Focus //20231101 [jjh]
        break;
    }
								...
								BOOL bSelectPastedCells /*=TRUE*/)
{
    ...
    // to hold this.
    LPSTR szBuffer = new char[(UINT)::GlobalSize(hmem)];
    if (!szBuffer)
        return FALSE;
...
//2023.10.31 Feeder Scroll Focus
BOOL CGridCtrl::GetHScrollClicked() //20231101 [jjh]
{
    return m_bHScrollClicked;
}
void CGridCtrl::SetHScrollClicked(BOOL bClicked) //20231101 [jjh]
{
    m_bHScrollClicked = bClicked;
}
//
////////////////////////////////////////////////////////////////////////////////////
...
int CALLBACK CGridCtrl::pfnCellNumericCompare(LPARAM lParam1, LPARAM lParam2, LPARAM lParamSort)
{
	...
	float fValue1 = (float)::_tstof(pCell1->GetText());
	float fValue2 = (float)::_tstof(pCell2->GetText());
...
void CGridCtrl::OnLButtonDown(UINT nFlags, CPoint point)
{
...
#endif
    {
        ...
        else
        {
            ...
            m_nTimerID = SetTimer((UINT_PTR)WM_LBUTTONDOWN, m_nTimerInterval, 0);
        }
    }   
    m_LastMousePoint = point;
}
...
//		SimpleMessage("Printer is not Installed or not Worked!!!!   ");
		return;
	}
    dc.m_bPrinting = TRUE;
...
//        SimpleMessage(_T("Unable to load grid data"));
        return FALSE;
    }
    END_CATCH
