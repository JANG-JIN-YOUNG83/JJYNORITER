...
class __CUSTOMCONTROL_CLASS__ CGridCtrl : public CWnd
{
...
public:
    ...
    BOOL GetHScrollClicked(); //20231101 [jjh]
    void SetHScrollClicked(BOOL bClicked);  //20231101 [jjh]
    //
...
protected:
    ...
    BOOL        m_bHScrollClicked; //2023.10.31 Feeder Scroll Focus  //20231101 [jjh]
